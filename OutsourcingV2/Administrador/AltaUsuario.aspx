				...
				<div class="col-xs-12 ">
					...
					<div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
								...
								<div class="row">
									...
									<div class="col-8">
										...
										<div class="row">
											<br />
											<br />
											<asp:Button ID="btnAgregarPersona" runat="server" Text="Agregar" Width="150px" />
											<br />
											<br />
											<asp:Button ID="btnCancelarPersona" runat="server" Text="Cancelar" Width="150px" />
											<br />
											<br />
											<asp:Label ID="lblPersonaMensaje" runat="server" Text=""></asp:Label>
										</div>
									</div>
									<div class="col-2"></div>
								</div>
						...
						<div class="tab-pane fade" id="navAgregarUsuario" role="tabpanel" aria-labelledby="nav-contact-tab">
							...
							<br />
							<asp:Label ID="lblConfirmPassword" runat="server" Text="Confirmar Contraseña:"></asp:Label><br />
							...
							<br />
							<asp:Button ID="btnAltaUsuario" runat="server" Text="Generar Usuario" Width="150px" /><br />
							<br />
							<asp:Button ID="btnCancelarAltaUsuario" runat="server" Text="cancelar" Width="150px" />
						</div>
						...
						<div class="tab-pane fade" id="navUsuarios" role="tabpanel" aria-labelledby="nav-about-tab">
							...
							<div class="row align-text-center">
								<h3 class="text-primary">Usuarios Activos del sistema: </h3>
							</div>
							<div class="scrollbar-primary">
								<div class="overflow-auto ">
									<asp:GridView ID="grdUsuariosSistema" runat="server" Class="table-responsive table-striped  table-hover " BorderStyle="Outset" scrollbar="true" higth="500px"></asp:GridView>
								</div>
							</div>
						</div>
					</div>
